...
<head>
    ...
    <script src="{$BASE_URL}javascript/bootstrap/bootstrap-notify.js"></script>
    <script src="{$BASE_URL}javascript/bootstrap/star-rating.js"></script>
    <script src="{$BASE_URL}javascript/bootstrap/bootstrap.js"></script>
