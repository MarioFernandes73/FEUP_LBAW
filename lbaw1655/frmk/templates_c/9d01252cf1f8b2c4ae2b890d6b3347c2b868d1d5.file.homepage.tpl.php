...
<?php /*%%SmartyHeaderCode:39004642658f35ddb48fce1-99440127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '39004642658f35ddb48fce1-99440127',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_58f35ddb570355_57427142',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f35ddb570355_57427142')) {function content_58f35ddb570355_57427142($_smarty_tpl) {?><!-- Main component for a primary marketing message or call to action -->
    <div class="jumbotron">
                        ...
                        <div class="item active">
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                                <div class="thumbnail" style="border: none">
                                    <img src="http://lorempixel.com/400/200/" alt="chair">
                                    <div class="caption" style="text-align: center; font-size: 3vmin">
                                        <a href="auction.html">Amazing Chair!<br></a>
                                        <label>Antiquities<br>00:30:58</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                            ...
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                                <div class="thumbnail" style="border: none">
                                    <img src="http://lorempixel.com/400/200/" alt="...">
                                    <div class="caption" style="text-align: center; font-size: 3vmin">
                                        <a href="auction.html">Toys Collection<br></a>
                                        <label>Others<br>
                                            01:17:21</label>
                                    </div>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                                <div class="thumbnail" style="border: none">
                                    <img src="http://lorempixel.com/400/200/" alt="...">
                                    <div class="caption" style="text-align: center; font-size: 3vmin">
                                        <a href="auction.html">Brown Hat<br></a>
                                        <label>Clothes<br>
                                            00:41:34</label>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                                <div class="thumbnail" style="border: none">
                                    <img src="http://lorempixel.com/400/200/" alt="...">
                                    <div class="caption" style="text-align: center; font-size: 3vmin">
                                        <a href="auction.html">Cutlery Set<br></a>
                                        <label>Indoor<br>
                                            00:50:00</label>
                                    </div>
                                </div>
                        ...
                        <div class="item active">
                            ...
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                                <div class="thumbnail" style="border: none">
                                    <img src="http://lorempixel.com/400/200/" alt="...">
                                    <div class="caption" style="text-align: center; font-size: 3vmin">
                                        <a href="auction.html">Twin bed<br></a>
                                        <label>Indoor<br>
                                            12:30:54</label>
                                    </div>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="col-lg-4 col-xs-4 col-md-4 col-sm-4">
                                <div class="thumbnail" style="border: none">
                                    <img src="http://lorempixel.com/400/200/" alt="...">
                                    <div class="caption" style="text-align: center; font-size: 3vmin">
                                        <a href="auction.html">Golden Chandelier<br></a>
                                        <label>Decoration<br>
                                            4 days 16:04:59</label>
                                    </div>
                                </div>
                            </div>
                        </div>
