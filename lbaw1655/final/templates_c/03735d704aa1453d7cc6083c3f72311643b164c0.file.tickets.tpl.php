<?php /* Smarty version Smarty-3.1.15, created on 2017-05-29 17:33:20
    ...
    <div class="row main">
        <div class="main-login main-center">
            ...
            <?php if ($_smarty_tpl->tpl_vars['msg']->value!='') {?>
                <form class="form-horizontal my-style" method="POST" action="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;?>
actions/tickets/reportComment.php">
                    <h2 class="text-center mytext">Ticket</h2>
...
" readonly></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea title="ticket message" required="required" name="message" class="form-control" rows="5" id="comment"
